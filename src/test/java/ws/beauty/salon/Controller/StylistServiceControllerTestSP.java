...
public class StylistServiceControllerTestSP {
     @Autowired
    private MockMvc mvc;
    ...
    @Test
    public void getByStylistIdNotFoundTest() throws Exception {
        mvc.perform(get("http://localhost:8080/api/v1/stylist_services/stylist/9999")
                .accept(MediaType.APPLICATION_JSON))
                .andDo(print())
